...
const Login = () => {
    ...
    return (
        <div className='w-full flex flex-col items-center justify-center gap-10 py-20'>
            ...
            <div className='w-full flex items-center justify-center gap-10'>
                <div onClick={googleSignOutHandler} className='text-base w-60 h-12 tracking-wide border-[1px] border-gray-400 rounded-md flex items-center justify-center gap-2 hover:border-blue-600 cursor-pointer duration-300'>

...
const ProductsCard = ({ product }) => {
  ...
  return (
    <div className='group relative'>
      <div onClick={detailHandler} className='w-full h-96 cursor-pointer overflow-hidden'>
        ...
        <div className='flex justify-between items-center'>
          ...
          <div className='flex justify-end gap-2 relative overflow-hidden w-28 text-sm'>
            ...
            <p onClick={() =>
              ...
              className='absolute z-20 w-[100px] text-gray-500 hover:text-gray-900 flex items-center gap-1 top-0 transform translate-x-32 group-hover:translate-x-0 transition-transform duration-500 cursor-pointer'>add to card</p>
          </div>
        </div>
        <div>
